...
from telemetrix_rpi_pico_2w_ble.telemetrix_ble import TelemetrixBle
...
class TelemetrixRpiPico2wBle:
    """
    This class exposes and implements the telemetrix API for the
    Raspberry Pi Pico 2W using Python threading for concurrency. It
    uses the BLE Nordic UART service as a data transport.
    ...
    def __init__(self, ble_device_name="Tmx4Pico2W",
                 sleep_tune=0.000001,
                 autostart=True,
        ...
        # server firmware version to be stored here
        ...
        # This dictionary is a list of gpio pins updated with the pin mode
        # when a pin mode is set.
        ...
        print(f"TelemetrixRpiPicoW2_BLE:  Version"
              f" {PrivateConstants.TELEMETRIX_VERSION}\n\n"
              f"Copyright (c) 2026 Alan Yorinks All Rights Reserved.\n")

        print(f'Connecting to BLE device {self.ble_device_name}...')
    ...
    def start_aio(self):
        """
        This method completes the instantiation of the TelemetrixRpiPico2Ble
        ...
        self.ble_device = TelemetrixBle(self.ble_device_name,
        ...
        if not self.firmware_version:
            ...
            print(f'Telemetrix4RpiPico2W_Ble firmware version:'
    ...
    def get_cpu_temperature(self, threshold=1.0, polling_interval=1000,
                            callback=None):
        """
    ...
    def set_pin_mode_servo(self, pin_number, min_pulse=1000, max_pulse=2000):
        ...
        self._set_pin_mode(pin_number, PrivateConstants.AT_SERVO, min_pulse,
                           max_pulse)
    ...
    def spi_read_blocking(self, register, number_of_bytes, spi_port=0,
                          call_back=None):
        """
    ...
    def stepper_disable_outputs(self, motor_id):
        ...
        during time.sleep and then re-enable with enableOutputs() before stepping
        again.
    ...
    def _send_command(self, command):
        ...
        self.ble_device.write(send_message)
    ...
    def _ble_report_dispatcher(self, sender, data):
        """
